# [Flexi](../Docs.md) : [Flexi](Flexi.md) : InterpolateVector4\<T>
## Declaration #1
```cs
...
| keyFrames | [FlexiKeyFrame](../FlexiKeyFrame/FlexiKeyFrame.md)\<Vector4>[] | The key frames to interpolate between |
...
Declaration #2 constructs a new [FlexiKeyFrame\<Vector4>](../FlexiKeyFrame/FlexiKeyFrame.md) array using [FlexiKeyFrame\<T>.CreatePair\<K>](../FlexiKeyFrame/CreatePairK.md)

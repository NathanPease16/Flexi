...
Declaration #2 constructs a new [FlexiKeyFrame\<Vector2>](../FlexiKeyFrame/FlexiKeyFrame.md) array using [FlexiKeyFrame\<T>.CreatePair\<K>](../FlexiKeyFrame/CreatePairK.md)
